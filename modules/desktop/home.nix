...
#     kdePackages.filelight kdePackages.kate kdePackages.kolourpaint kdePackages.konversation  # kdePackages.kalk kodi
...
#     obs-studio
#     piper plex-desktop plex-mpv-shim protonplus protontricks # protonup-qt
#     qalculate-qt quasselClient qbittorrent # quadrapassel
#     r2modman remmina
#     /* sameboy */ skypeforlinux smplayer svp #     slippi-netplay
#     vlc
#     wine
#     zapzap zoom-us
# #     (nixgl.nixGLNvidia.override { inherit (pkgs) mesa; }).wrapApp
